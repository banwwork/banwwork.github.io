...
const 반지름 = 5
const 책정보 = [
  { 제목: '빈칸의 도서관', 저자: '조현지', 쪽수: '144p', 크기: '150 × 211 mm' },
  { 제목: 'CUBIC', 저자: '우연식', 쪽수: '162p', 크기: '165 × 240 mm' },
  { 제목: '디자인 어질리티 + 큐큐', 저자: '사록', 쪽수: '470p', 크기: '105 × 170 mm' },
  { 제목: '책은 전진한다 - 책, 시간, 공간', 저자: '신신', 쪽수: '202p', 크기: '150 × 211 mm' },
  { 제목: '해변의 거리', 저자: '사사키 마키', 쪽수: '420p', 크기: '152 × 212 mm' },
  { 제목: '만화책 형태에 관한 만화책', 저자: '이율리', 쪽수: '240p', 크기: '125 × 187 mm' },
  { 제목: '혓바늘', 저자: '못니', 쪽수: '260p', 크기: '100 × 170 mm' },
  { 제목: '만화의 이해', 저자: '스콧 맥클라우드', 쪽수: '256p', 크기: '180 × 260 mm' },
  { 제목: '뭐가 먼저냐', 저자: '정대봉', 쪽수: '128p', 크기: '181 × 221 mm' }
]

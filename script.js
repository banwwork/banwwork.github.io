const projects = [
  ...
  { title: "Fledgling Season", category: "Poster", year: "2024", client: "Poster Project", color: "c-blue", image: "./images/Poster Project 2_idea.jpg", description: "학이 둥지를 떠나 처음 비행하는 시기를 강렬한 블루와 세밀한 드로잉으로 표현한 포스터입니다." },
  { title: "Think Again", category: "Poster", year: "2024", client: "Poster Project", color: "c-red", image: "./images/Poster Project 1_ Complex.jpg", description: "생각이 많아 방향을 잃는 감각을 달팽이와 뇌, 반복되는 문장으로 시각화한 실험적인 포스터입니다." },
